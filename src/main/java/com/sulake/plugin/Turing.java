...
public class Turing extends HabboPlugin implements EventListener {
    public static Turing Instance;
    ...
    private void prepareTable(){
        try (Connection connection = Emulator.getDatabase().getDataSource().getConnection()) {
            String ADD_COLUMN_QUERY = "ALTER TABLE `users` ADD COLUMN `events_won` INT(11) NOT NULL DEFAULT '0';";
